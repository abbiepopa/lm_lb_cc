...
p.adjust(c(0.0111, 0.00513, 0.0477, 0.319, 0.0000119), method = 'fdr')
...
p.adjust(c(0.018, 0.130, 0.117, 0.0323, 0.136), method = 'fdr')
...
#only anterior significant
p.adjust(0.0217, method = 'fdr', n = 5) #does not survive
...
#anterior and mid-anterior significant
p.adjust(c(0.0276, 0.00026), method = 'fdr', n = 5)
#anterior does not survive, mid-anterior does